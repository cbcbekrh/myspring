...
<div id="menu">
    <ul>
        <li id="logo"><a href="<c:url value='/'/>">MySpring</a></li>
...
<div style="text-align:center">
    <div class="board-container">
        <div class="search-container">
            ...
            <button id="writeBtn" class="btn btn-write" onclick="location.href='<c:url value="/board/write"/>'"><i class="fa fa-pencil"></i> 글쓰기</button>
            <button id="listBtn" class="btn btn-list" onclick="location.href='<c:url value="/board/list"/>'"><i class="fa fa-bars"></i> 목록</button>
        </div>
